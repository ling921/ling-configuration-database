...
[SQLite 示例](https://github.com/ling921/ling-configuration-database/tree/master/samples/Ling.Configuration.Database.Sample) 会创建本地数据库表、读取示例值并演示选项重载。
...
本项目采用 [MIT 许可证](https://github.com/ling921/ling-configuration-database/blob/master/LICENSE)。
